...
export interface LotteryQueryGetValidatorsWinnerResponse {
  ValidatorsWinner?: LotteryValidatorsWinner;
}
...
export interface LotteryValidatorsWinner {
  winner?: string;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/game/lottery/bet/{sender}
   */
  queryBet = (sender: string, params: RequestParams = {}) =>
    this.request<LotteryQueryGetBetResponse, RpcStatus>({
      path: `/game/lottery/bet/${sender}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/game/lottery/params
   */
